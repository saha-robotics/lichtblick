  ...
  it("handles protobuf int64 values", () => {
    ...
    */
    ...
    expect(
      ...
      int64map: { "-999999999999997300": -999999999999997300n },
      uint64map: { "10000000000000000700": 10000000000000000700n },
      sint64map: { "-999999999999997300": -999999999999997300n },
      fixed64map: { "10000000000000000700": 10000000000000000700n },
      sfixed64map: { "-999999999999997300": -999999999999997300n },
      nested: [
        {
          int64: -999999999999997300n,
          uint64: 10000000000000000700n,
